    ...
    <div className="bg-black">
      ...
      <div className="pt-14 px-2 sm:px-3 pb-2 overflow-x-hidden">
        <div className="relative z-10 max-w-7xl mx-auto">
          {/* Main Dashboard Grid - Stack on mobile, side by side on larger screens */}
          ...
          <div className="md:col-span-9 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4">
            {/* Top Stats Row - 1 column on mobile, 2 columns on sm, 2 columns on lg+ */}
            <div className="sm:col-span-1 lg:col-span-2 bg-gradient-to-br from-[#150050]/80 to-[#3F0071]/60 backdrop-blur-sm border border-[#610094]/30 rounded-2xl p-3 sm:p-4 shadow-2xl">
              <h3 className="text-[#610094] text-xs sm:text-sm font-semibold mb-1 sm:mb-2 uppercase tracking-wider">Total Questions</h3>
              <div className="text-2xl sm:text-3xl font-bold text-white">
                <CountUp to={5754} duration={2} />
              </div>
            </div>

            <div className="sm:col-span-1 lg:col-span-2 bg-gradient-to-br from-[#150050]/80 to-[#3F0071]/60 backdrop-blur-sm border border-[#610094]/30 rounded-2xl p-3 sm:p-4 shadow-2xl">
              <h3 className="text-[#610094] text-xs sm:text-sm font-semibold mb-1 sm:mb-2 uppercase tracking-wider">Total Active Days</h3>
              <div className="text-2xl sm:text-3xl font-bold text-white">
                <CountUp to={1138} duration={2} />
              </div>
            </div>

            {/* Heatmap - Full width on mobile, 2 columns on sm, 8 columns on lg+ */}
            <div className="sm:col-span-2 lg:col-span-8 bg-gradient-to-br from-[#000000]/90 to-[#150050]/80 backdrop-blur-sm border border-[#610094]/30 rounded-2xl p-4 shadow-2xl">
              <CustomHeatmap />
            </div>
